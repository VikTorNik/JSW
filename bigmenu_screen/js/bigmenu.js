...
export const bigMenuText = [
  ...
  ["Онлайн розрахунки", "Миттєві розрухунки параметрів перемичок, шин, дротів"],
  ["Контакти", "Контактна інформація виробника та умови виготовлення"],
  ["Кошик", "Оформлення замовленої продукції"],
];
